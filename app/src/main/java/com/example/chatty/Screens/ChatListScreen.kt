...
import com.example.chatty.CommonRow
import com.example.chatty.DestinationScreens
import com.example.chatty.TitleText
import com.example.chatty.navigateTo

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ChatListScreen(navController: NavController, vm: ChattyViewModel) {
                        ...
                        LazyColumn(modifier = Modifier.weight(1f)) {
                            items(chats) { chat ->
                                ...
                                CommonRow(imageUrl = chatUser.imageUrl, name = chatUser.name) {
                                    chat.chatId?.let { idString->
                                        navigateTo(
                                            navController,
                                            DestinationScreens.SingleChat.createRoute(idString)
                                        )
                                    }
                                }
                            }
